...
class Calc():
    ...
    def deg_2nd_click(self, clicked):
        if clicked == 'deg':
            ...
            btn_power["text"] = {True: get_super('y') + "√x", False: "x" + get_super('y')}[
                btn_power["text"] == "x" + get_super('y')]
...
btn_sub = Button(root, text="-", padx=30, pady=15, bd=4, font=myfont, bg="#eff1f4",
                 command=lambda: c.DMAS_mod_Click('-'))
...
btn_reciprocal = Button(root, text='x' + get_super('-1'), padx=21, pady=15, bd=4, bg="#eff1f4", font=myfont,
                        command=lambda: c.rec_fact_click('r'))
btn_power = Button(root, text='x' + get_super('y'), padx=27, pady=15, bd=4, bg="#eff1f4", font=myfont,
                   command=lambda: c.pow_pc_clicked('pow'))
...
btn_permucombo = Button(root, text="nCr", padx=20, pady=15, bd=4, bg="#eff1f4", font=myfont,
                        command=lambda: c.pow_pc_clicked('c'))
btn_random = Button(root, text="Ran#", padx=16, pady=15, bd=4, bg="#eff1f4", font=myfont,
                    command=lambda: c.epiRanClick('Ran'))
...
btn_log10 = Button(root, text="log", padx=20, pady=15, bd=4, bg="#eff1f4", font=myfont,
                   command=lambda: c.trig_log_root_click('g'))
btn_loge = Button(root, text="ln", padx=26, pady=15, bd=4, bg="#eff1f4", font=myfont,
